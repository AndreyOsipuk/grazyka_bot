...
import {
  pluralizeMinutes,
  pluralizeMinutesGenitive,
} from "./utils/pluralizeMinutes";
...
⚠⚠⚠️ <b>Внимание!</b> Вы должны написать приветственную анкету (имя, пол, возраст, город, фото или мем 18+) в течение ${pluralizeMinutesGenitive(TIME_LIMIT_MINUTES)} после вступления, иначе будете забанены. ⚠⚠⚠
